                ...
                <div class="panel-body">
                    ...
                    <div id="alert-success" class="alert alert-success" style="display:none"></div>
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" id="btnSingkron" onclick="getCode('senin')" class="btn btn-primary btn-sm" >
                                <i class="fa fa-plus fa-fw"></i> Senin
                            </button>
                            <button type="button" id="btnSingkron" onclick="getCode('selasa')" class="btn btn-primary btn-sm" >
                                <i class="fa fa-plus fa-fw"></i> Selasa
                            </button>
                            <button type="button" id="btnSingkron" onclick="getCode('rabu')" class="btn btn-primary btn-sm" >
                                <i class="fa fa-plus fa-fw"></i> Rabu
                            </button>
                            <button type="button" id="btnSingkron" onclick="getCode('kamis')" class="btn btn-primary btn-sm" >
                                <i class="fa fa-plus fa-fw"></i> Kamis
                            </button>
                            <button type="button" id="btnSingkron" onclick="getCode('jumat')" class="btn btn-primary btn-sm" >
                                <i class="fa fa-plus fa-fw"></i> Jumat
                            </button>
                            <button type="button" id="btnSingkron" onclick="getCode('sabtu')" class="btn btn-primary btn-sm" >
                                <i class="fa fa-plus fa-fw"></i> Sabtu
                            </button>
                            <button type="button" id="btnSingkron" onclick="getCode('minggu')" class="btn btn-primary btn-sm" >
