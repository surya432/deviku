        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    List All Laporan <button type="button" onclick="btnAdd()" class="btn btn-success btn-xs" data-toggle="modal" id="btnAdd" data-target="#modelId"> <i class="glyphicon glyphicon-plus"></i> Tambah Laporan</button>
                </div>
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid" id="form-editor">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="date" id="date" readonly value='{{ now() }}' >
                                        </div>
                                        <div class="form-group">
                                            <label for="User Name">User Name</label>
                                            <input type="text" name="user_id" id="user_id"  value='{{ Sentinel::getUser()->id }}'  hidden>
                                            <input type="text" class="form-control" name="username" id="username" required readonly value='{{Sentinel::getUser()->first_name}}'>
                                        </div>
