...
<head>
	...
	<script>jwplayer.key="zGhSOpbt7hbdG53nW3nDZE0vdyyjy0cNdaQNfA==";</script>
    <!-- Bootstrap -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    <style>
        body{overflow:hidden;background-color:#111;}
        .spinner {
        margin: 150px auto 0;
        width: 70px;
        text-align: center;
...
<body>
    <script type="text/javascript">
        var bttCount=4;var h=35;
        //if(bttCount<2) h=1; else {if($(window).width()>(100*bttCount)) h=35; else h=100;}
        var video={width:$(window).width(),height:$(window).height()-h};
        $(function() {getPlayer();});
    ...
    <script type="text/javascript">
        ...
        function showPlayer(link_id) {
            $("#myElement").html('<div class="spinner"><div class="bounce1"></div> <div class="bounce2"></div> <div class="bounce3"></div></div><div id="notif" class="text-center"><p style="color: blue;">Tunggu Sebentar Ya... :D :)</p></div>');
                    ...
                    success: function (html) {				
                        if (html) {
                            if (html.match(/^http/g)) {
                                $("#myElement").html('<iframe src="'+html+'" frameborder=0 marginwidth=0 marginheight=0 scrolling=no width="'+video.width+'" height="'+video.height+'" allowfullscreen></iframe>');
