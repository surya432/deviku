            ...
            foreach ($data as $content) {
                if (!$this->CheckHeaderCode($content->f720p) && $this->CheckHeaderCode($content->f360p)) {
                    ...
                    if ($idDrive) {
                        ...
                        $returnData .= '"C:\Program Files (x86)\Internet Download Manager\IDMan.exe" /d "' . $this->getVideoLinkProxy($this->GetIdDrive($idDrive), $content->url . "-720p" ) . '" /a /n ' . " \n";
                    }
                    ...
                    if ($idDrive) {
                        ...
                        $returnData .= '"C:\Program Files (x86)\Internet Download Manager\IDMan.exe" /d "' . $this-> getVideoLinkProxy($this->GetIdDrive($idDrive), $content->url . "-360p") . '" /a /n ' . " \n";
                    }
                } else if (!$this->CheckHeaderCode($content->f360p) && !$this->CheckHeaderCode($content->f720p)) {
