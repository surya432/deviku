...
trait HelperController
{
    ...
    {
        $curl = $this->viewsource("https://www.googleapis.com/drive/v3/files?q='" . $id_folder . "'+in+parents&pageSize=25&orderby=modifiedByMeTime&supportsAllDrives=true&supportsTeamDrives=true");
