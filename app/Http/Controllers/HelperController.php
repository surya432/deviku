...
trait HelperController
{
    ...
    public function renameopenload360($id_oload, $name)
    {
    ...
    public function check_openload360($url)
    {
    ...
    public function checkfile_openload360($url)
    {
        $id_upload = $url;
    ...
    public function check_openload720($url)
    {
        $id_upload = str_replace("upload_id=", "", $url);
    ...
    public function checkfile_openload720($url)
    {
        $id_upload = $url;
