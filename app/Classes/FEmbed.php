...
class FEmbed
{
    ...
    public function fembedUpload($data)
    {
        $response = $this->clientCurl("/download", $data);
        return json_decode($response, true);
    }
    public function fembedCheck($data)
    {
        $response = $this->clientCurl("/downloading", $data);
        return json_decode($response, true);
    }
    public function fembedFile($data)
    {
        $response = $this->clientCurl("/file", $data);
        return json_decode($response, true);
    }
    public function fembedAccount($data, $mirror)
    {
